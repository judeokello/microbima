...
export class RecoveryController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns first 140 customers (by createdAt) with their policies. Each row is one policy or one customer without policy (policy number N/A). For temporary reconciliation of member numbers on cards vs DB.',
  })
