...
export class BeneficiaryMapper {
  ...
  static fromBeneficiaryDto(
    ...
    const trimmedIdNumber = dto.idNumber != null ? dto.idNumber.trim() || null : null;
    const mappedIdType = SharedMapperUtils.mapIdTypeFromDto(dto.idType);
    const relationshipRaw = dto.relationshipDescription ?? dto.relationship;
    const relationship = relationshipRaw != null ? relationshipRaw.trim() || null : null;

    const beneficiaryData: BeneficiaryData = {
      id: '', // Will be generated by database
      customerId: customerId,
      firstName: (dto.firstName ?? '').trim(),
      middleName: dto.middleName != null ? dto.middleName.trim() || null : null,
