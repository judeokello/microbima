...
export function MessageDetail({ deliveryId, basePath }: MessageDetailProps) {
  ...
  const backHref =
    searchParams.get('from') === 'customer' && backCustomerId
      ...
      : basePath
  const backLabel = backHref.includes('?tab=messages')
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p>
                {delivery?.requestedLanguage} → {delivery?.usedLanguage ?? '-'}
              </p>
            </div>
            <div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <pre className="mt-1 max-h-64 overflow-auto whitespace-pre-wrap rounded bg-gray-50 p-3 text-sm">
